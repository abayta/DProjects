package functionalRequirement38;
...
public class ListAllActiveAppointmentPatient {
	...
	public void checkFindAllAppointmentsPatientPositive() {
		...
		Collection<Appointment> appointments = appointmentService.findAllActiveByPatient(11);
