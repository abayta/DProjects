...
@Controller
@RequestMapping("/participant/administrator")
public class ParticipantAdministratorController extends AbstractController {
	...
	public ParticipantAdministratorController() {
		super();
	}
